...
namespace eudaq {
  ...
  public:
    ...
    static lcio::LCEvent *ConvertToLCIO(DetectorEvent *, DetectorEvent *);
    static lcio::LCEvent *ConvertToLCIO(DetectorEvent *, DetectorEvent *, DetectorEvent *);

    static void ConvertStandardSubEvent(StandardEvent &, const Event &);
    static void ConvertLCIOSubEvent(lcio::LCEvent &, const Event &);
    static void ConvertLCIOSubEvent(lcio::LCEvent &, const Event *, const Event *);
    static void ConvertLCIOSubEvent(lcio::LCEvent &, const Event *, const Event *, const Event *);
